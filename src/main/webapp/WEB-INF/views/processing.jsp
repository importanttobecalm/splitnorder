  ...
  <div class="w-full max-w-[760px] bg-surface-container-lowest rounded-[24px] soft-shadow p-8 md:p-[56px]">
    ...
    <c:if test="${job.status == 'COMPLETED'}">
      <div class="flex justify-center">
        <a href="${ctx}/job/${job.publicId}" class="bg-primary hover:bg-primary-container text-on-primary px-8 py-4 rounded-xl font-body-md font-medium flex items-center gap-2 transition-all shadow-md">
